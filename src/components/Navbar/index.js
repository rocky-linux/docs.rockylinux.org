...
export default () => {
    ...
    return (
        <>
            ...
            <div className={ `navbar h-14 bg-white dark:bg-gray-900 px-4 flex items-center text-black dark:text-white sm:hidden fixed w-full transition duration-300 ease-in-out z-50${scrollPos > 0 ? ' shadow-lg' : ''}` }>
            ...
            <div className={`navbar h-14 bg-white dark:bg-gray-900 px-4 flex justify-center items-center text-black dark:text-white hidden sm:flex fixed w-full transition duration-300 ease-in-out z-50${scrollPos > 0 ? ' shadow-md' : ''}`}>
