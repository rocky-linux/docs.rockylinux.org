                ...
                <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
                    <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Links" dir="auto">
                        <div className="px-5 py-2">
                            <a href="https://wiki.rockylinux.org/" className="text-base text-gray-600 dark:text-gray-400 hover:text-gray-500 dark:hover:text-white">
                                Wiki
                            </a>
                        </div>
                    </nav>
                    <div className="mt-8 flex justify-center space-x-6">
                        <a href="https://twitter.com/rocky_linux" className="text-gray-600 dark:text-gray-400 hover:text-gray-500 dark:hover:text-white">
                        ...
                        <a href="https://reddit.com/r/rockylinux" className="text-gray-600 dark:text-gray-400 hover:text-gray-500 dark:hover:text-white">
                            <span className="sr-only">Reddit</span>
                            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 670 670" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://forums.rockylinux.org/" className="text-gray-600 dark:text-gray-400 hover:text-gray-500 dark:hover:text-white">
                        ...
                        <a href="https://chat.rockylinux.org/" className="text-gray-600 dark:text-gray-400 hover:text-gray-500 dark:hover:text-white">
                            <span className="sr-only">Mattermost</span>
                        ...
                        <a href="https://github.com/rocky-linux" className="text-gray-600 dark:text-gray-400 hover:text-gray-500 dark:hover:text-white">
